...
public class panel implements ActionListener {
    ...
    public Container createPanel() {
        ...
        ImageIcon imgArrow = new ImageIcon(
                new ImageIcon(".\\icons\\arrow.png").getImage().getScaledInstance(30, 30, Image.SCALE_DEFAULT));
        ...
        docIzq = new JLabel();
        ImageIcon imgdocIzq = new ImageIcon(
                new ImageIcon(".\\icons\\puntos.png").getImage().getScaledInstance(25, 20, Image.SCALE_SMOOTH));
        ...
        docDer = new JLabel();
        ImageIcon imgdocDer = new ImageIcon(
                new ImageIcon(".\\icons\\puntos.png").getImage().getScaledInstance(25, 20, Image.SCALE_SMOOTH));
        ...
        /*
         * System.out.println(width); System.out.println(heigth);
    ...
    private void setChart(String s, int p){
        try {
            JTextField aux = listP.get(p);
                aux.setText(s);
        } catch (Exception e) {
    ...
    private void positionArrow(int m) {
        int x =arrow.getX();
        if(m==1){
            x=x+24;
        }else{
        ...
        arrow.setBounds(x, arrow.getY(), arrow.getWidth(), arrow.getHeight());
    }
